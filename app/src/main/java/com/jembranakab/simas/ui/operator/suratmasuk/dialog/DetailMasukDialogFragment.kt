package com.jembranakab.simas.ui.operator.suratmasuk.dialog
...
class DetailMasukDialogFragment : BaseDialogFragment() {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        return activity.let { activity ->
            ...
            with(dialogView) {
                ...
                suratOperatorVM.listDetailKeluar.observe(this@DetailMasukDialogFragment, {
                    when (it) {
    ...
    companion object {
        fun newInstance(): DetailMasukDialogFragment {
            return DetailMasukDialogFragment()
        }
    }
